# Project ARSS — Portfolio

**Adaptive Respiratory Support System for Extreme Environments**
...
- Click any team / mentor / gallery photo slot to upload an image (saved in your
  browser, per device).
- In the Documentation section, use **Attach PDF** to open a PDF in the built-in viewer.

## Note on values
Design targets are marked as concept/simulation values and will be updated after
experimental validation. No academic review has been completed yet — the review
section is a template to fill in as reviews happen.
